function [dist,lons,lats] = ll2dist(long,lat,N)
% ll2dist (originally M_LLDIST from the m_map package)
% Spherical earth distance between points in long/lat coordinates. 
